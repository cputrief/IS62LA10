...
<body>
    <div class="text-center mt-3 pt-3 bg-white">
        ...
        @else
        <div class="alert alert-secondary d-inline-block">Nilai Invalid</div>
        @endif


        <br>
        {{-- setelah membuat @if wajid ditutup menggunakan @endif --}}
